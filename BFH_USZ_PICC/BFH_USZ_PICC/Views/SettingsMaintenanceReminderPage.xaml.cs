...
{
    public sealed partial class SettingsMaintenanceReminderPage : BaseContentPage
    {
        public SettingsMaintenanceReminderPage(ContentPage contained) : base(contained)
        {
            InitializeComponent();
