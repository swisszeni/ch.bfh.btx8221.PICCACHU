    ...
    public class KnowledgeEntries
    {
        ...
        public static List<KnowledgeEntryTypeGroup> getEntries()
        {
            ...
            if (knowledgeEntryList == null)
            {
                ...
                KnowledgeEntryTypeGroup maintenanceInstructionsGroup = new KnowledgeEntryTypeGroup("Pflegeanleitungen", "Pflegeanleitungen");
                ...
                howToPlaceAPicc.Add(new KnowledgeEntryTextElement("Ob der PICC richtig platziert ist, überprüfen die Fachleute anhand einer Röntgenaufnahme oder mit einem anderen Darstellungsverfahren. Danach ﬁxieren sie den aus dem Körper herausführenden Abschnitt des Katheters mit einer eigens dafür entwickelten Haftplatte (StatLock) auf der Haut. Den Bereich um die Austrittsstelle des Katheters bedecken sie mit einem sterilen Verband. Lässt die Wirkung des Lokalanästhetikums nach dem Einlegen des Katheters nach, können während ein oder zwei Tagen leichte Schmerzen auftreten."));
