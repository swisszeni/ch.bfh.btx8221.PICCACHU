    ...
    public class GlossaryEntries
    {
        ...
        public static List<GlossaryEntry> getEntries()
        {
            ...
            if (glossaryList == null)
            {
                ...
                glossaryList.Add(new GlossaryEntry("Katheter", "Ein weicher Schlauch, der in den Körper eingeführt wird. In diesem Fall handelt es sich um einen peripheren zentralen Venenkatheter (PICC: Peripherally inserted central venous catheter), der in eine Armvene eingeführt wird. Die Spitze des Katheters beﬁndet sich in einem Bereich mit grosser Blutzirkulation in der Nähe des Herzens. Durch den Katheter können verschiedene Medikamente und Flüssigkeiten verabreicht werden. Dadurch ist es nicht nötig, eine Nadel (Kanüle) direkt in die Vene einzuführen."));
                ...
                glossaryList.Add(new GlossaryEntry("PICC", "Auch: peripher eingeführter zentraler Venenkatheter\nOder: peripherally inserted central venous catheter\nEin Katheter, der in eine der Armvenen eingeführt wird und bis in die Nähe des Herzens führt. Medikamente, die durch den Katheter verabreicht werden, können sich gut mit dem Blut vermischen. Dieser Katheter kann mit optimaler Pflege bis zu mehrere Monate im Körper verbleiben."));
                ...
                glossaryList.Add(new GlossaryEntry("Verstopfter Katheter", "Ein Katheter mit einem blockierten Hauptkanal. In diesem Fall sind keine Infusionen oder Blutentnahmen durch den Katheter mehr möglich."));
