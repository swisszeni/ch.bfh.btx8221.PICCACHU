    ...
    public class GlossaryEntries
    {
        ...
        public static List<GlossaryEntry> getEntries()
        {
            ...
            if (glossaryList == null)
            {
                ...
                glossaryList.Add(new GlossaryEntry("Intravenöse Therapie (IV-Therapie)", "Ein Medikamenten oder eine Flüssigkeit wird durch eine Vene verabreicht."));
